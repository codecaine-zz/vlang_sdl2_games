#!/usr/bin/env python3
"""Generate 120 BPM magical orchestral theme for Peggle."""
...
def generate_soundtrack() -> bytes:
    ...
    # Ode to Joy / Magical orchestral theme in D major
    melody_notes = [
        62, 62, 64, 66, 66, 64, 62, 61,
        59, 59, 61, 62, 62, 61, 61, 0,
        62, 62, 64, 66, 66, 64, 62, 61,
        59, 59, 61, 62, 61, 59, 59, 0,
    ]
    ...
    for i in range(num_steps):
        ...
        note = melody_notes[(i // 2) % len(melody_notes)]
        if note == 0:
            continue
...
def main() -> None:
    ...
    out_path = out_dir / "peggle_bgm.wav"
    ...
    local_path = root / "peggle" / "assets" / "music" / "peggle_bgm.wav"
